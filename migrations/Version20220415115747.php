...
final class Version20220415115747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE house (id INT AUTO_INCREMENT NOT NULL, district_id INT DEFAULT NULL, address VARCHAR(255) NOT NULL, balance_holder VARCHAR(255) NOT NULL, entrances_quantity INT DEFAULT NULL, apartments_quantity INT DEFAULT NULL, INDEX IDX_67D5399DB08FA272 (district_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
